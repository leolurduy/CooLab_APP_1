 ...
 * @param {Object} props
 * @param {string} props.currentPage - Página actual activa
 * @param {Function} props.setCurrentPage - Función para cambiar de página
 * @param {string} props.language - Idioma actual
 * @param {Function} props.setLanguage - Función para cambiar idioma
 * @param {Object} props.translations - Objeto con las traducciones
 * @param {Object} props.supabaseStatus - Estado de conexión con Supabase
 * @param {Function} props.handleRefreshFromSupabase - Función para refrescar datos
 */
const Navigation = ({ 
  currentPage, 
  setCurrentPage, 
        ...
        <div className="flex justify-between h-20">
          ...
          <div className="flex items-center space-x-5">
            ...
            <button
              ...
              className={`ml-6 px-4 py-3 rounded-md text-base font-medium transition-colors whitespace-nowrap ${
                currentPage === "home" 
            ...
            <button
              ...
              className={`px-4 py-3 rounded-md text-base font-medium transition-colors whitespace-nowrap ${
